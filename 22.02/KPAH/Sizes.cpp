...
#endif
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNCREATE(Sizes, CView)
Sizes::Sizes()
{
	m_pDC = NULL;
	m_pOldPalette = NULL;
...
#ifdef _DEBUG
void Sizes::AssertValid() const
{
	CView::AssertValid();
}

void Sizes::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// Sizes message handlers

void Sizes::Calculate()
{
	UpdateData(TRUE);
	if (Student=="")
	{
...
int Sizes::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void Sizes::OnSize(UINT nType, int cx, int cy) 
{
...
BOOL Sizes::OnEraseBkgnd(CDC* pDC) 
{
	return CView::OnEraseBkgnd(pDC);
}

BOOL Sizes::PreCreateWindow(CREATESTRUCT& cs) 
{
	cs.style |= WS_CLIPSIBLINGS | WS_CLIPCHILDREN;
	return CView::PreCreateWindow(cs);
}

void Sizes::OnLButtonDown(UINT nFlags, CPoint point) 
{
	SetCapture();
	Lbutt=TRUE;
    LDOWX=point.x;
...
void Sizes::OnLButtonUp(UINT nFlags, CPoint point) 
{
	Lbutt=FALSE;
...
void Sizes::OnMouseMove(UINT nFlags, CPoint point) 
{
	PMouse=point;
...
BOOL Sizes::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt) 
{
...
void Sizes::OnMButtonDown(UINT nFlags, CPoint point) 
{
	SetCapture();
	ShiftSta=TRUE;
	mouseX=point.x;
...
void Sizes::OnMButtonUp(UINT nFlags, CPoint point) 
{
	ReleaseCapture();
	ShiftSta=FALSE;
