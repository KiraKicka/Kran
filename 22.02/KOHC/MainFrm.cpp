...
//{{AFX_MSG_MAP(CMainFrame)
	...
	ON_COMMAND(ID_VARIANTS, OnVariants)
...
{
	SwitchToForm(IDD_MAIN, (CView*)new KOHCView);
}
void CMainFrame::OnVariants()	//Переключиться на выдачу заданий  
{
	SwitchToForm(IDD_VARIANTS, (CView*)new Variants);
}
